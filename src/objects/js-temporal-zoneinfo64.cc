...
#define TEMPORAL_NO_ICU_INTERNAL_INCLUDES 1

#ifdef V8_INTL_SUPPORT
#if TEMPORAL_NO_ICU_INTERNAL_INCLUDES
/** Shadow definition of struct UDataMemory */
...
ZoneInfo64Provider::ZoneInfo64Provider() {
  ...
  const UDataMemoryShadow *shadowMemory = reinterpret_cast<const UDataMemoryShadow*>(memory);
